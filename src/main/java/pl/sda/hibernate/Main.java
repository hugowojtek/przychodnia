...
public class Main {
    ...
    private static void choice() {
        ...
        switch (number) {
            case 1:
                ...
                hibernateDBService.getJpaDBallDoctorsAndSpecial();
                break;
            ...
            case 2:
                ...
                hibernateDBService.insertJpaDBnewDoctor(lekarz);
                break;
            ...
            case 3:
                ...
                hibernateDBService.removeJpaDBdoctor(id);
                break;
            ...
            case 5:
                ...
                hibernateDBService.getJpaDBallPatients();
                break;

            case 6:
                hibernateDBService.getJpaDBVisitsWithDate();
                break;
            ...
            case 7:
                ...
                hibernateDBService.getJpaDBallPatients();
                Long id3 = getPatient();
                hibernateDBService.getJpaDBpatientDetails(id3);
                break;
            ...
            case 8:
                ...
                hibernateDBService.insertJpaDBnewPatient(pacjent);
                break;
            ...
            case 9:
                ...
                hibernateDBService.removeJpaDBpatient(id4);
                break;
            ...
            case 11:
                ...
                if (hibernateDBService.insertJpaDBnewVisit(idDoctor, idPatient, dateVisit)) {
            ...
            case 12:
                ...
                hibernateDBService.removeJpaDBvisit(idVisit);
                break;
            ...
            case 13:
                ...
                hibernateDBService.getJpaDBvisitsAllForDoctorWithDate(idDoctor2);
                break;

            case 14:

                hibernateDBService.getJpaDBvisitsAllForEveryDoctorsWithDate();
                break;

            case 15:
                hibernateDBService.getJpaDBallPatients();
                long idPatient2 = showVisitForPatient();
                hibernateDBService.getDBvisitsAllForPatient(idPatient2);
                break;
    ...
    private static Pacjenci enterNewPatient(Pacjenci pacjent) {
        ...
        wojewodztwa = hibernateDBService.getJpaDBDistrictByIdNumber(spec);
    ...
    private static Lekarze enterNewDoctor(Lekarze lekarz) {
        ...
        specjalizacje = hibernateDBService.getJpaDBSpecializationByIdNumber(spec);
